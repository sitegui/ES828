...
\setlength{\itemsep}{-1ex}
   \item ES868 - Pré Relatório Lab 3
   \item Controlador proporcional
   \item Controlador de Ziegler Nichols
\end{itemize}


\subsection*{ES868 – Pré Relatório Lab 3}

\begin{par}
\textbf{Controle de plantas eletrˆonicas utilizando um controlador PID digital}
\end{par} \vspace{1em}
\begin{par}
Turma A - 16/03/2015
\end{par} \vspace{1em}
...
\setlength{\itemsep}{-1ex}
   ...
   \item Vinícius Ragazi David - 120258
\end{itemize}
\begin{verbatim}
load ../G.mat
s = tf('s');
