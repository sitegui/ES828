...
\section{Objetivo}
\begin{par}
	O objetivo deste pré-roteiro foi encontrar os ganhos de um controlador que satisfaz os seguintes requisitos:
\end{par}
...
\ksi = frac{\sqrt{2}}{2}
\end{equation}
Terceiro polo alocado em $-30$\\
Erro nulo para entrada do tipo rampa.\\


\section{Encontrando os ganhos}
